    ...
    <div className="dashboard-shell group-task-shell">
      ...
      {isModalOpen && (
        <div className="ticket-modal-backdrop bg-black/50 backdrop-blur-sm">
          <div className="ticket-modal-card bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg shadow-2xl border border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleCreateTask} className="ticket-modal-form p-6 space-y-4">
              <div>
              ...
              <div className="ticket-modal-actions pt-4 flex justify-end gap-3 border-t dark:border-gray-700 mt-6">

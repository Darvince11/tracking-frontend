    ...
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="ticket-modal-backdrop bg-black/50 backdrop-blur-sm">
          <div className="ticket-modal-card bg-white dark:bg-[#1a1d27] rounded-2xl w-full max-w-lg shadow-2xl border border-gray-200 dark:border-gray-800">
            ...
            <form onSubmit={handleCreateTicket} className="ticket-modal-form p-6 space-y-4">
              ...
              <div className="ticket-modal-actions pt-4 flex justify-end gap-3 border-t mt-6 dark:border-gray-800">
